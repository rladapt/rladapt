...
def get_IoU(pred_bbox, gt_bbox):
    ...
    # print("gt={},pred={}".format(gt_bbox,pred_bbox))
    # print("ixmin={},iymin={},ixmax={},iymax={}".format(ixmin,iymin,ixmax,iymax))
    ...
    uni = ((pred_bbox[2] - pred_bbox[0]) * (pred_bbox[3] - pred_bbox[1]) +
           (gt_bbox[2] - gt_bbox[0]) * (gt_bbox[3] - gt_bbox[1]) -
           inters)

    # -----3----- iou
    overlaps = inters / uni
    # print(iw,ih,overlaps)
    return overlaps
